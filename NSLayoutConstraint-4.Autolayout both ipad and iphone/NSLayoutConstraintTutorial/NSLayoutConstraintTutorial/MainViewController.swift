...
class MainViewController: UIViewController {
    ...
    var label1:UILabel = {
        ...
        label.text = "Label 1"
        label.font = UIFont.systemFont(ofSize: UIDevice.getFloatValue(iphone: 15, ipad: 25))
    ...
    private func autolayoutLabel1() {
        ...
        view.addConstraint(NSLayoutConstraint(item: label1,
                                              ...
                                              attribute: .top,
                                              multiplier: 1,
                                              constant: UIDevice.getFloatValue(iphone: 40, ipad: 100)))
        ...
        view.addConstraint(NSLayoutConstraint(item: label1,
                                              ...
                                              multiplier: 1,
                                              constant: UIDevice.getFloatValue(iphone: 100, ipad: 200)))
        ...
        view.addConstraint(NSLayoutConstraint(item: label1,
                                              ...
                                              attribute: .notAnAttribute,
                                              multiplier: 1,
                                              constant: UIDevice.getFloatValue(iphone: 50, ipad: 80)))
    }
    private func autolayoutLabel2() {
        ...
        view.addConstraint(NSLayoutConstraint(item: label2,
                                              ...
                                              attribute: .right,
                                              multiplier: 1,
                                              constant: UIDevice.getFloatValue(iphone: 20, ipad: 120)))
